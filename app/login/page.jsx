...
const Login = () => {
  return (
    <div className="login-wrapper bg" style={{height:"100vh"}}>
      <div className="container">
        <div className="login-wrap flex justify-center ">
          <div className="login-nav-box w-1/2 p-10">
          ...
          <div className="aligned-box w-1/2">
            {/* <h1>Hello</h1> */}
